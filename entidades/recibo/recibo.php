                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="number" class="form-control mb-3" name="ID_recibo" placeholder="ID del Recibo">
                                    <input type="number" class="form-control mb-3" name="ID_contrato" placeholder="ID del Contrato">
                                    <input type="number" class="form-control mb-3" name="ID_nomina" placeholder="ID de la Nomina">
                                    <input type="number" class="form-control mb-3" name="Salario_bruto_recibo" placeholder="Salario Bruto">
                                    <input type="number" class="form-control mb-3" name="Comision_hiring" placeholder="Comision de Hiring Group">
                                    <input type="number" class="form-control mb-3" name="Descuento_inces" placeholder="Descuento Inces">
                                    <input type="number" class="form-control mb-3" name="Descuento_ivss" placeholder="Descuento de ivss">
                                    <input type="number" class="form-control mb-3" name="Salario_neto" placeholder="Salario Neto">
                                    <input type="date" class="form-control mb-3" name="Fecha_pago" placeholder="Fecha de Pago">
                                    <input type="text" class="form-control mb-3" name="Numero_recibo" value="1" placeholder="Numero del Recibo">
                            ...
                            <table class="table" >
                                <thead class="table-success table-striped" >
                                    <tr>
                                        ...
                                        <th>Salario Bruto</th>
                                        <th>Comision de Hiring Group</th>
                                        <th>Descuento Inces</th>
                                        <th>Descuento de ivss</th>
                                        <th>Salario Neto</th>
                                        <th>Fecha de Pago</th>
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php  echo $row['Salario_bruto_recibo']?></th>
                                                <th><?php  echo $row['Comision_hiring']?></th>
                                                <th><?php  echo $row['Descuento_inces']?></th>
                                                <th><?php  echo $row['Descuento_ivss']?></th>
                                                <th><?php  echo $row['Salario_neto']?></th>  
                                                <th><?php  echo $row['Fecha_pago']?></th>  
                                                <th><?php  echo $row['Numero_recibo']?></th>  
