...
<head>
    ...
    <title>Dashboard Hiring Group (Ofertas)</title>
    ...
    <main class="main-content">
        ...
        <div class="dashboard-section">
            <div class="tabs-navigation">   
                ...
                <button class="tab-trigger active" onclick="window.location.href='../oferta_laboral/ofert_laboral.php'">Ofertas</button>
                <button class="tab-trigger" onclick="window.location.href='../postulante/postulante.php'">Candidatos</button>
                
            </div>

            <!-- Contenido de la pestaña Ofertas -->
