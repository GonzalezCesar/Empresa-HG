...
<html lang="es">
    <head>
        <title> Experiencia Eaboral</title>
        <meta charset="UTF-8">
                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="number" class="form-control mb-3" name="ID_expeLa" placeholder="ID Experiencia Laboral">
                                    <input type="number" class="form-control mb-3" name="ID_postulante" placeholder="ID del Postulante">
                                    <input type="text" class="form-control mb-3" name="Empresa_expeLa" placeholder="Empresa donde Trabajo">
                                    <input type="text" class="form-control mb-3" name="Cargo_expeLa" placeholder="Puesto que ocupo">
                                    <input type="date" class="form-control mb-3" name="Fecha_inicio_expeLa" placeholder="Fecha Inicio">
                                    <input type="date" class="form-control mb-3" name="Fecha_fin_expeLa" placeholder="Fecha Fin">
                                    <input type="text" class="form-control mb-3" name="Descripcion_expeLa" placeholder="Descripcion del puesto de trabajo">
                                    <input type="text" class="form-control mb-3" name="Referencia_expeLa" value="1" placeholder="Referencias">
                        ...
                        <div class="col-md-8">
                            <table class="table" >
                                <thead class="table-success table-striped" >
                                    <tr>
                                        <th>ID Experiencia Laboral</th>
                                        <th>ID del Postulante</th>
                                        <th>Empresa donde Trabajo</th>
                                        <th>Puesto que ocupo</th>
                                        <th>Fecha Inicio</th>
                                        <th>Fecha Fin</th>
                                        <th>Descripcion del puesto de trabajo</th>
                                        <th>Referencias</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['ID_expeLa"']?></th>
                                                <th><?php  echo $row['ID_postulante']?></th>
                                                <th><?php  echo $row['Empresa_expeLa']?></th>
                                                <th><?php  echo $row['Cargo_expeLa']?></th>
                                                <th><?php  echo $row['Fecha_inicio_expeLa']?></th>
                                                <th><?php  echo $row['Fecha_fin_expeLa']?></th>
                                                <th><?php  echo $row['Descripcion_expeLa']?></th>
                                                <th><?php  echo $row['Referencia_expeLa']?></th>  
                                                <th><a href="actualizar.php?id=<?php echo $row['ID_expeLa"'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete.php?id=<?php echo $row['ID_expeLa"'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
