                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="number" class="form-control mb-3" name="ID_usuEmpre" placeholder="ID del Usuario de la Empresa">
                                    <input type="number" class="form-control mb-3" name="ID_empresa" placeholder="ID de la Empresa">
                                    <input type="number" class="form-control mb-3" name="ID_usuario" placeholder="ID usuario">
                                    <input type="text" class="form-control mb-3" name="Nombre_usuEmpre" placeholder="Nombre del Representante de la Empresa">
                                    <input type="text" class="form-control mb-3" name="Apellido_usuEmpre" placeholder="Apellidos del Representante de la Empresa">
                                    <input type="text" class="form-control mb-3" name="Cargo_usuEmpre" placeholder="Cargo en la Empresa">
                                    <input type="text" class="form-control mb-3" name="Telefono_usuEmpre" placeholder="Telefono">
                                    <input type="checkbox" class="form-control mb-3" name="Contacto_Principal_usuEmpre" value="1" placeholder="Es el contacto Principal de la Empresa?">
                        ...
                        <div class="col-md-8">
                            <table class="table" >
                                <thead class="table-success table-striped" >
                                    <tr>
                                        <th>ID del Usuario de la Empresa</th>
                                        <th>ID de la Empresa</th>
                                        <th>ID usuario</th>
                                        <th>Nombre del Representante de la Empresa</th>
                                        <th>Apellidos del Representante de la Empresa</th>
                                        <th>Cargo en la Empresa</th>
                                        <th>Telefono</th>
                                        <th>Es el contacto Principal de la Empresa?</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['ID_usuEmpre"']?></th>
                                                <th><?php  echo $row['ID_empresa']?></th>
                                                <th><?php  echo $row['ID_usuario']?></th>
                                                <th><?php  echo $row['Nombre_usuEmpre']?></th>
                                                <th><?php  echo $row['Apellido_usuEmpre']?></th>
                                                <th><?php  echo $row['Cargo_usuEmpre']?></th>
                                                <th><?php  echo $row['Telefono_usuEmpre']?></th>
                                                <th><?php  echo $row['Contacto_Principal_usuEmpre']?></th>  
                                                <th><a href="actualizar.php?id=<?php echo $row['ID_usuEmpre"'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete.php?id=<?php echo $row['ID_usuEmpre"'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
