...
$sql="UPDATE formacion_academica SET `ID_postulante`='$ID_postulante',
                       `Institucion_FormaAcad`='$Institucion_FormaAcad',
                       `Titulo_FormaAcad`='$Titulo_FormaAcad', 
                       `Fecha_inicio_FormaAcad`='$Fecha_inicio_FormaAcad', 
                       `Fecha_fin_FormaAcad`='$Fecha_fin_FormaAcad', 
                       `Descripcion_FormaAcad`='$Descripcion_FormaAcad'
                       WHERE ID_FormaAcad='$ID_FormaAcad'";
