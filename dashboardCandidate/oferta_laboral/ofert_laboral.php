...
<head>
    ...
    <title>Dashboard-Candidate (Ofertas)</title>
    <link rel="stylesheet" href="candidate-ofertas.css">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-section">
            <div class="tabs-navigation">
                <button class="tab-trigger active" onclick="window.location.href='dashboard-candidate-ofertas.html'">Ofertas laborales</button>
                <button class="tab-trigger" onclick="window.location.href='dashboard-candidate-postulaciones.html'">Postulaciones</button>
            ...
            <div id="ofertas" class="tab-content active">
                <div class="offer-card">
                    <h3 class="offer-title">Nombre de la oferta</h3>
                    <p class="offer-detail">Salario</p>
                    <p class="offer-detail">Empresa</p>
                    <p class="offer-detail">Profesión</p>
                </div>
                <div class="offer-card">
                    <h3 class="offer-title">Nombre de la oferta</h3>
                    <p class="offer-detail">Salario</p>
                ...
                <p class="table-info" style="margin-top: 2rem;">Formato para hacer listado desde la BD de la entidad OFERTAS</p>
            </div>
        </div>
    </main>
    <script>
