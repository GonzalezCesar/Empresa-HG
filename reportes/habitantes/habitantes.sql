...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2025 a las 23:03:11
...
CREATE TABLE `habitantes` (
  ...
  `financiamiento` int(30) NOT NULL,
...
--
ALTER TABLE `habitantes`
  ADD CONSTRAINT `habitantes_ibfk_1` FOREIGN KEY (`id-casa`) REFERENCES `casa` (`codigo`);
COMMIT;
